...
| 23      | Write the test plan with 3 functional and 3 non-functional                                                                     | Procedures in which one should take to test the program and descriptions of the expected outcome of each test is on Github                                                                     | 90min           | Dec 8                  | B         |
